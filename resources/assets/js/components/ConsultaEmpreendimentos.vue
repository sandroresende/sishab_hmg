...
<div>
   <div class="form-group">   
        ...
        <div class="form-group row" v-if="!(estado || (situacaoObra.length>0 && this.situacaoObra[0] != ''))">
        ...
        <div class="form-group row" v-if="!apfdigitado">        
             <div class="col-sm-12">
                ...
                <select 
                    ...
                    <option v-for="empreendimento in empreendimentos" v-text="empreendimento.txt_nome_empreendimento" :value="empreendimento.txt_num_apf" :key="empreendimento.txt_num_apf"></option>
                </select>                                  
            </div>    
        </div>   
        <!--
...
<script>
    export default {
        ...
        mounted() {
            ...
            axios.get(this.url + '/api/executivo/situacaoObra').then(resposta => {
                //console.log(resposta.data);
             ...
             axios.get(this.url + '/api/modalidades').then(resposta => {
                ...
                console.log(erro);
                        ...
                        axios.get(this.url + '/api/executivo/statusEmpreendimento').then(resposta => {
                //console.log(resposta.data);
                this.statusEmpreendimentos = resposta.data;
            }).catch(erro => {
                console.log(erro);
