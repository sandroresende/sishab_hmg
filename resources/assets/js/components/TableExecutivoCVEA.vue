                ...
                <div class="table-responsive">		
                    ...
                    <tbody>
                        ...
                        <tr v-for="item in dados">                        
                            ...
                            <td v-if="item.faixa_renda_id == 5" class="tabelaNumero text-center">{{formatarValor(item.num_nao_entregues,0)}}</td>
                        ...
                        <tr v-for="item in dados">                        
                            ...
                            <td v-if="item.faixa_renda_id == 6" class="tabelaNumero text-center">{{formatarValor(item.num_nao_entregues,0)}}</td>
                         ...
                         <tr v-for="item in dados">                        
                            ...
                            <td v-if="item.faixa_renda_id == 7" class="tabelaNumero text-center">{{formatarValor(item.num_nao_entregues,0)}}</td>
                        ...
                        <tr class="totalFaixa">
                            ...
                            <td class="tabelaNumero text-center">{{formatarValor(totalGrupo1.nao_entregues + totalGrupo3.nao_entregues + totalGrupo2.nao_entregues,0)}}</td>
                        ...
                        <tr v-for="item in dados">                        
                         ...
                         <tr class="total">
                            ...
                            <td class="tabelaNumero text-center">{{formatarValor(valoresCVEA.nao_entregues,0)}}</td>
    ...
    export default {
      ...
      data() {
            return {
               ...
               totalGrupo1: {uh: 0, vigentes: 0, valor: 0, nao_entregues: 0, entregues: 0, distratadas: 0, valor_liberado: 0},     
               totalGrupo2: {uh: 0, vigentes: 0, valor: 0, nao_entregues: 0, entregues: 0, distratadas: 0, valor_liberado: 0},  
               totalGrupo3: {uh: 0, vigentes: 0, valor: 0, nao_entregues: 0, entregues: 0, distratadas: 0, valor_liberado: 0},               
               valoresCVEA: {uh: 0, vigentes: 0, valor: 0, nao_entregues: 0, entregues: 0, distratadas: 0, valor_liberado: 0}
            }
      ...
      mounted() {
             ...
             for(var i = 0; i < this.dados.length; i++){
                if(this.dados[i].faixa_renda_id == 0){
                    ...
                    this.totalGrupo1.nao_entregues += parseInt(this.dados[i].num_nao_entregues);
                    ...
                    this.totalGrupo2.nao_entregues += parseInt(this.dados[i].num_nao_entregues);
                    ...
                    this.totalGrupo3.nao_entregues += parseInt(this.dados[i].num_nao_entregues);
                    ...
                    this.valoresCVEA.nao_entregues += parseInt(this.dados[i].num_nao_entregues);
