...
<div id="portal-breadcrumbs">
        ...
        <span dir="ltr" id="breadcrumbs-1">        
            <a href="{{url('/novo_executivo/filtro')}}">Consulta Relatório Executivo</a>
            <span class="breadcrumbSeparator">
                &gt;
        ...
        <span dir="ltr" id="breadcrumbs-2">
            <span id="breadcrumbs-current">Relatório Executivo  <span class="badge badge-primary">Novo</span></span>
        </span>
...
<div id="content">
    ...
    <div id="viewlet-below-content-title">
        <div class="documentByLine" id="plone-document-byline">
            <!--
            <span class="documentModified"><span>última atualização</span> {{date('d/m/Y',strtotime($dataPosicao))}}</span>
            -->
        </div>
...
<!--Tabela MCMV 1-->
           ...
           <p> Situação da Obra:
                @foreach($situacoesSelecionadas as $situacoes)
                - {{$situacoes->txt_situacao_obra}}&nbsp 
                @endforeach
                </p>    
            @endif    
            ...
            <div class="titulo">
                ...
                <a href="{{url('novo_executivo/relatorio/detalhesContratacao/')}}"  style="color:tomato;"> Detalhar <i class="fa fa-arrow-circle-right" style="color:#2b90d9;"></i></a></span></h5>
            </div>
          ...
          <DIV>
          <a class="btn btn-outline-secondary btn-block text-reset" href='{{ url("executivo/download"."/".$dadosPropostas["regiao"]."/".$dadosPropostas["estado"]."/".$dadosPropostas["municipio"]."/".$dadosPropostas["rm_ride"]."/".$dadosPropostas["ano_de"]."/".$dadosPropostas["ano_ate"])}}'>Donwload para Excel</a>
          </DIV>
