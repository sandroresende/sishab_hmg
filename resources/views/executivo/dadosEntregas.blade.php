                ...
                <table class="table table-striped table-hover table-sm">
                        ...
                        @foreach($entregas as $entrega)                           
                                <tr>                   
                                    ...
                                    <td class="text-center">{{$entrega->dsc_faixa}}</td>  
                                    ...
                                    @foreach($totalEntregas as $totalUf)                                                                      
                                    @if($totalUf->txt_sigla_uf == $entrega->txt_sigla_uf) 
                                        @if($totalUf->txt_modalidade == $entrega->txt_modalidade) 
                                            @if($totalUf->dsc_faixa == $entrega->dsc_faixa) 
                        ...
                        @foreach($totalEntregasAno as $total)
                            <tr>                   
                                ...
                                <td class="text-center">{{number_format($totalUH,0, ',' , '.')}}</td> 
                            </tr>  
                            @endforeach  
                            </tbody>
                        </table> 
