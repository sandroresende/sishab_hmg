...
<div id="portal-breadcrumbs">
    ...
    <span dir="ltr" id="breadcrumbs-2">
        <span id="breadcrumbs-current">Consulta Quadro Resumo de Solicitações e Liberações</span>
    </span>
...
<div id="content">
    ...
    <div id="viewlet-above-content-title"></div>
        ...
        Quadro Resumo de Solicitações e Liberações
        </h2>
    ...
    <div id="content-core">
            ...
            <div class="form-group">
               <form action="{{ url('pagamento/quadroResumo') }}" method="POST">
                    @csrf
                    <div class="well">
                        <div class="box">                                                                                 
                        <select-solicitacoes-pagamento :url="'{{ url('/') }}'"></select-solicitacoes-pagamento>
                        </div>
                    </div>    
