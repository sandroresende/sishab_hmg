...
<div id="portal-breadcrumbs">
    ...
    <span dir="ltr" id="breadcrumbs-2">
        <span id="breadcrumbs-current">Consulta Situação Solicitações de Pagamento</span>
    </span>
...
<div id="content">
    ...
    <div id="viewlet-above-content-title"></div>
        ...
        Situação Solicitações de Pagamento
        </h2>
    ...
    <div id="content-core">
            ...
            <div class="form-group">
               <form action="{{ url('/solicitacao/medicao') }}" method="POST">
                    @csrf
                    <div class="well">
                        <div class="box">                                                                                 
