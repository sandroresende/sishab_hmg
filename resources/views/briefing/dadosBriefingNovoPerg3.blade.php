...
<!--Tabela MCMV 1-->
        ...
        <div class="titulo">
                <h5>3. Dos contratos de financiamento em execução (ativos) no estado, quais tiveram liberações em 2019 
                (parcelas onerosas e não onerosas)? Para cada um desses, qual o valor financiado e qual o valor liberado em 2019 – 
                (parcelas onerosas e não onerosas), qual objeto e quais municípios contemplados?</h5>
            </div>
            ...
            <div class="table-responsive">		
                    ...
                    <tr class="totalFaixa">
                            ...
                            <td class="tabelaNumero text-center">{{number_format($valoresFgts['uh_contratadas'],0, ',' , '.')}}</td>
                            <td class="tabelaNumero text-center">{{number_format($valoresFgts['contratos'],0, ',' , '.')}}</td>
                            <td class="tabelaNumero text-center">{{number_format($valoresFgts['valor_liberado'],2, ',' , '.')}}</td>
                            <td class="tabelaNumero text-center">{{number_format($valoresFgts['municipio'],0, ',' , '.')}}</td>
                            <td class="tabelaNumero text-center" data-toggle="popover" title="Popover Header" data-content="Some content inside the popover">{{number_format(($valoresFgts['valor_liberado']/1000000)*22,0, ',' , '.')}}</td>
                        </tr>                         
                        </tfoot>                                      
                </table>           <!-- VALORES CONTRATADOS ANO -->
        </div>
        @endif
