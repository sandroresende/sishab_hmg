...
<p>Prezados,</p>
<p>Um novo usuário acaba de se registrar no <strong>SISHAB</strong> para representar o <b>{{ $usuario->entePublicoProponente->txt_ente_publico }}</b>. Por favor analise a permissão do usuário.</p>
