    ...
    <div class="card-body">
        ...
        <div class="row ">                                    
            <div class="column col-xs-12 col-md-2">
                ...
                <input id="txt_cod_operacao" type="text" class="form-control input-relatorio" name="txt_cod_operacao" value="{{$dadosEmpreendimento->txt_cod_operacao}}" disabled >
            </div>
            <div class="column col-xs-12 col-md-2">
            ...
            <div class="column col-xs-12 col-md-2">
                ...
                <input id="dte_legalizacao" type="text" class="form-control input-relatorio" name="dte_legalizacao" value="@if($dadosEmpreendimento->dte_legalizacao) {{date('d/m/Y',strtotime($dadosEmpreendimento->dte_legalizacao))}}@endif" disabled >
            </div>           
        </div>
        <!--fim row-->                                                                                                                         
        ...
        <div class="row">
            <div class="column col-xs-12 col-md-2">
                ...
                <input id="txt_tipologia" type="text" class="form-control input-relatorio" name="txt_tipologia" value="{{$dadosEmpreendimento->txt_tipologia}}" disabled >
            </div>
