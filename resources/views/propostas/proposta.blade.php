...
<div id="portal-breadcrumbs">
    ...
    <span dir="ltr" id="breadcrumbs-1">        
        <a href="{{url('/propostas')}}">Consulta à Seleção de Propostas</a>
        <span class="breadcrumbSeparator">
            &gt;
    ...
    <span dir="ltr" id="breadcrumbs-1">        
        <a href="#" onclick="javascript:window.history.go(-1)">Propostas Apresentadas</a>
        <span class="breadcrumbSeparator">
            &gt;
    ...
    <span dir="ltr" id="breadcrumbs-2">
        <span id="breadcrumbs-current">Proposta</span>
    </span>
</div> 
...
<div id="content">
    ...
    <div id="viewlet-above-content-title"></div>
        <h2  class="documentFirstHeading text-center">
            {{$proposta->txt_nome_empreendimento}}
        </h2>
        <span class="documentFirstHeadingSpan">   
                {{strtoupper($proposta->txt_modalidade)}}
        </span>   
      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <span class="documentByLine">
                    <span class="summary-view-icon">Posição:{{date('d/m/Y',strtotime($operacao->dte_movimento))}}</span>  
                </span>   
                </div>
            </div>
        </div>   
