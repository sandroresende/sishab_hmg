            ...
            <form action="{{ url('prototipo/salvar') }}" method="post">
                @csrf
                    ...
                    <div class="form-group">
                        <div class="row">        
                            <div class="column col-xs-12  col-md-12">
                                <label for="name" class="control-label"> <h4 class="card-title">Nome da Proposta</h4></label>
                                <input id="txt_nome_prototipo" type="text" class="form-control" name="txt_nome_prototipo" required >
                            </div>
                       </div> 
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="column col-xs-12 col-md-6">
                                <input class="btn btn-lg btn-info btn-block" type="submit" value="Criar Proposta">                           
                            </div>
                            <div class="column col-xs-12 col-md-6">
