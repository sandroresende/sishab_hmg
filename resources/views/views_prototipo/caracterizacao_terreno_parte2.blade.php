    ...
    <div id="content"> 
        ...
        <div id="content-core"> 
            ...
            <div class="form-group">
                <form action="{{ url('prototipo/iniciar/caracterizacaoTerreno/parte2/salvar/') }}" role="form" method="POST" enctype="multipart/form-data">
                     @csrf
                     <div class="well">
                         <div class="box">  
                             <input type="hidden" class="form-control" id="prototipo_id" name="prototipo_id" value="{{$prototipo->id}}">                                                        
                             <caracterizacao-terreno-parte2 :url="'{{ url('/') }}'" ></caracterizacao-terreno-parte2>
                         </div>
                     </div>    
