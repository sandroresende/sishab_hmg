            ...
            <div class="form-group">
                <div class="titulo">
                    <h5>1. Caracterização Básica do Terreno</h5>                     
                </div>
                <div class="card">
                      <div class="card-body">
            ...
            <!--
                            <div class="row">
                                <div class="column col-xs-12 col-md-12">
                                    <label class="control-label "><strong style="color:grey">2.2. Existem obras pendentes para a infraestrutura que servirá ao terreno?</strong></label>
                            ...
                            <div class="row">
                                <div class="column col-xs-12 col-md-12">                                    
                                    <div class="row">
                                        <div class="column col-xs-12 col-md-4">                                            
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="ckboxAbastecimentoAgua" value="option1" @if($infraBasica->bln_sistema_abastecimento_pendentes) checked @endif disabled>
                                                <label class="form-check-label" for="inlineCheckbox1">Sistema de abastecimento de água</label>
                                            </div>
                                        </div>  
                                        <div class="column col-xs-12 col-md-4">                                            
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="ckboxEsgoto" value="option2" @if($infraBasica->bln_sistema_coleta_esgoto_pendentes) checked @endif  disabled>
                                                <label class="form-check-label" for="inlineCheckbox2">Sistema de coleta e destinação de esgoto</label>
                                            </div>
                                        </div>  
                                        <div class="column col-xs-12 col-md-4">                                            
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="ckboxAguasPluviais" value="option3" @if($infraBasica->bln_sistema_renagem_ag_pluviais_pendentes) checked @endif  disabled>
                                                <label class="form-check-label" for="inlineCheckbox3">Sistema de drenagem de águas pluviais</label>
                                            </div>
                                        </div>  
                                    </div>
                                    <div class="row">    
                                        <div class="column col-xs-12 col-md-4">  
                                              <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="ckboxEnergiaEletrica" value="option1" @if($infraBasica->bln_dist_energia_eletrica_pendentes) checked @endif  disabled>
                                                <label class="form-check-label" for="inlineCheckbox1">Sistema de distribuição de energia elétrica</label>
                                              </div>
                                        </div>  
                                        <div class="column col-xs-12 col-md-4">         
                                              <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="ckboxIluminacao" value="option2" @if($infraBasica->bln_iluminacao_publica_pendentes) checked @endif  disabled>
                                                <label class="form-check-label" for="inlineCheckbox2">Sistema de iluminação pública</label>
                                              </div>
                                        </div>  
                                        <div class="column col-xs-12 col-md-4">   
                                              <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="ckboxGuiasSarjetas" value="option3" @if($infraBasica->bln_guias_sarjetas_pendentes) checked @endif  disabled>
                                                <label class="form-check-label" for="inlineCheckbox3">Guias e sarjetas</label>
                                              </div>
                                        </div>
                                    </div>
                                    <div class="row">                                    
                                        <div class="column col-xs-12 col-md-4">       
                                              <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="ckboxPavimentacao" value="option3" @if($infraBasica->bln_pavimentacao_pendentes) checked @endif  disabled>
                                                <label class="form-check-label" for="inlineCheckbox3">Pavimentação</label>
                                              </div>
                                        </div> 
                                        <div class="column col-xs-12 col-md-8">       
                                            <div class="form-check form-check-inline">
                                              <input class="form-check-input" type="checkbox" id="ckboxPavimentacao" value="option3" @if($infraBasica->bln_outras_pendentes) checked @endif  disabled>
                                              <label class="form-check-label" for="inlineCheckbox3">Outras:</label>
                                              @if($infraBasica->bln_outras_pendentes)
                                                <input id="txt_outras_obras_pendentes" type="text" class="form-control" name="txt_outras_obras_pendentes" value=" {{$infraBasica->txt_outras_obras_pendentes}}" disabled>                                    
                                            @endif    
                                            </div>
                                      </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="card">                     
                        <div class="card-body">
                            ...
                            <label class="control-label ">III. Equipamentos Públicos Comunitários (por transporte público)</label>                                                               
                            <div class="row">
                                <div class="column col-xs-12 col-md-4">
                                ...
                                <div class="column col-xs-12 col-md-4">
                                    ...
                                    <label class="control-label ">- Escola pública de ensino fundamental (ciclo I) @if(!$insercaoUrbana->bln_escola_ed_fund_ciclo_1 ) <span class="text-danger">(Não possui)</span> @endif</label></label>
                                    <div class="row">
                                ...
                                <div class="column col-xs-12 col-md-4">
                                    ...
                                    <label class="control-label ">- Escola pública de ensino fundamental (ciclo II) @if(!$insercaoUrbana->bln_escola_ed_fund_ciclo_2 ) <span class="text-danger">(Não possui)</span> @endif</label></label>
                                    <div class="row">
                            ...
                            <div class="row">
                                <div class="column col-xs-12 col-md-4">
                                    ...
                                    <label class="control-label ">- Centro de Referência de Assistência Social (CRAS) @if(!$insercaoUrbana->bln_cras ) <span class="text-danger">(Não possui)</span> @endif</label></label>
                                    <div class="row">
                                ...
                                <div class="column col-xs-12 col-md-4">
                                    ...
                                    <label class="control-label ">- Unidade Básica de Saúde (UBS) @if(!$insercaoUrbana->bln_ubs ) <span class="text-danger">(Não possui)</span> @endif</label></label>
                                    <div class="row">
