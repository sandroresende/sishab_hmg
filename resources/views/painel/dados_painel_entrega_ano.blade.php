...
<div id="portal-breadcrumbs">
        ...
        <span dir="ltr" id="breadcrumbs-1">        
            <a href="{{url('/resumo/contratacao/ano/filtro')}}">Consulta Resumo de Entregas</a>
            <span class="breadcrumbSeparator">
                &gt;
        ...
        <span dir="ltr" id="breadcrumbs-2">
            <span id="breadcrumbs-current">Resumo de Entregas<span class="badge badge-primary">Novo</span></span>
        </span>
...
<div id="content">
    ...
    <div id="content-core">
        @if(count($entregaAno)>0)
        <div class="form-group">       

            <div class="card-header text-center">
                <strong class="text-white">
                    <h2>Resumo de Entregas <span>@if($ano_de){{$ano_de}} @endif</span></h2>   
                </strong>                
            </div>
...
<!--Tabela MCMV 1-->
            ...
            @if(($parametrosFiltro == 0 && $parametrosRegionais == 0) || ($parametrosFiltro == 1 && $parametrosRegionais == 0))
            <div class="titulo">
            ...
            <div class="table-responsive">		
                    ...
                    @endforeach   
                            <tr class="total">                         
                                ...
                                <td class="tabelaNumero text-center">{{number_format($valoresMCMV['entregues'],0, ',' , '.')}}</td>
                            </tr>
                        </tbody>                                        
                </table>
            ...
            @if($parametrosRegionais == 1 && $parametrosFiltro == 1)
            <div class="titulo">
                <h5>UNIDADES HABITACIONAIS <span style="float:right; font-size:13px;">                
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-5">
                    <p>Total Nacional: <span class="font-weight-bold">{{number_format($valoresMCMV['entregues'],0, ',' , '.')}}</span>.</p>
                </div>
            ...
            <div class="col-xs-12 col-sm-1 text-right">
                ...
                <div class="col-xs-12 col-sm-5">
                   <p> Total Investido: <span class="font-weight-bold">R$  {{number_format($liberacaoEntrega,0, ',' , '.')}}</span></p>
                </div>
            </div>            
        </div>
