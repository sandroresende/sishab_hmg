...
<div id="portal-breadcrumbs">
        ...
        <span dir="ltr" id="breadcrumbs-2">
            <span id="breadcrumbs-current">Consulta Contratos Vigentes</span>
        </span>
    </div>
...
<div id="content">
    ...
    <div id="content-core">
            ...
            <div class="form-group">
               <form action="{{ url('painel/vigentes') }}" method="POST">
                    @csrf
                    <div class="well">
                        <div class="box">                                                                                 
                            <select-painel :url="'{{ url('/') }}'" vidvigente = "false"  ateano = "true"></select-painel>
                        </div>
                    </div>    
