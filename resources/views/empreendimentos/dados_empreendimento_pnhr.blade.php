                         ...
                         <div class="card-body">
                            ...
                            <div class="row"> 
                                ...
                                <div class="column col-xs-12 col-md-4">
                                    ...
                                    <input id="dte_efetiva_conclusao" type="text" class="form-control input-relatorio" name="dte_efetiva_conclusao" value="@if($dadosPnhr->dte_efetiva_conclusao) {{date('d/m/Y',strtotime($dadosPnhr->dte_efetiva_conclusao))}}@endif" disabled >
                                </div> 
                                <div class="column col-xs-12 col-md-4">
                                    <label class="control-label label-relatorio ">Primeira Entrega</label>
                                    <input id="dte_primeira_entrega" type="text" class="form-control input-relatorio" name="dte_primeira_entrega" value="@if($dadosPnhr->dte_primeira_entrega) {{date('d/m/Y',strtotime($dadosPnhr->dte_primeira_entrega))}}@endif" disabled >
                                </div> 
                                <div class="column col-xs-12 col-md-4">
                                    <label class="control-label label-relatorio ">Última Entrega</label>
                                    <input id="dte_ultima_entrega" type="text" class="form-control input-relatorio" name="dte_ultima_entrega" value="@if($dadosPnhr->dte_ultima_entrega) {{date('d/m/Y',strtotime($dadosPnhr->dte_ultima_entrega))}}@endif" disabled >
                                </div> 
                         ...
                         <div class="card-body">
                            ...
                            <div class="row">                                                    
                                <div class="column col-xs-12 col-md-4">
                                    ...
                                    <input id="prc_execucao_financeira_obra" type="text" class="form-control input-relatorio" name="prc_execucao_financeira_obra" value="{{number_format($dadosPnhr->prc_execucao_financeira_obra, 0, ',' , '.')}}" disabled >
                                </div>
                                <div class="column col-xs-12 col-md-4">
                                    <label class="control-label label-relatorio">% Financeiro Atec</label>
                                    <input id="prc_execucao_financeira_atec" type="text" class="form-control input-relatorio" name="prc_execucao_financeira_atec" value="{{number_format($dadosPnhr->prc_execucao_financeira_atec, 0, ',' , '.')}}" disabled >
                                </div>
                                <div class="column col-xs-12 col-md-4">
                                    <label class="control-label label-relatorio">% Financeiro TS</label>
                                    <input id="prc_execucao_financeira_ts" type="text" class="form-control input-relatorio" name="prc_execucao_financeira_ts" value="{{number_format($dadosPnhr->prc_execucao_financeira_ts, 0, ',' , '.')}}" disabled >
                                </div>            
                            </div>  
                            <div class="row">                             
                            ...
                            <div class="card-body">
                                ...
                                <div class="row ">                                    
                                    ...
                                    <div class="column col-xs-12 col-md-3">
                                        ...
                                        <input id="txt_natureza_contrato" type="text" class="form-control input-relatorio" name="txt_natureza_contrato" value="{{$dadosPnhr->txt_natureza_contrato}}" disabled >
                                    </div>
                                ...
                                <div class="row">
                                    <div class="column col-xs-12 col-md-3">
                                        ...
                                        <input id="vlr_atec" type="text" class="form-control  input-relatorio" name="vlr_atec" value="{{number_format($dadosPnhr->vlr_atec, 2, ',' , '.')}}" disabled >
                                    </div>
                                    <div class="column col-xs-12 col-md-3">
                                        <label class="control-label label-relatorio">Assit Técnica TS Cisterna</label>
                                        <input id="vlr_atec_ts_cisterna" type="text" class="form-control  input-relatorio" name="vlr_atec_ts_cisterna" value="{{number_format($dadosPnhr->vlr_atec_ts_cisterna, 2, ',' , '.')}}" disabled >
                                    </div>
                                    <div class="column col-xs-12 col-md-2">
                                        <label class="control-label label-relatorio">Cisterna</label>
                                        <input id="vlr_cisterna" type="text" class="form-control  input-relatorio" name="vlr_cisterna" value="{{number_format($dadosPnhr->vlr_cisterna, 2, ',' , '.')}}" disabled >
                                    </div>
                                    <div class="column col-xs-12 col-md-2">
                                        <label class="control-label label-relatorio">Efluentes</label>
                                        <input id="vlr_diferenca_juros" type="text" class="form-control  input-relatorio" name="vlr_efluentes" value="{{number_format($dadosPnhr->vlr_efluentes, 2, ',' , '.')}}" disabled >
                                    </div>
                                    <div class="column col-xs-12 col-md-2">
                                        <label class="control-label label-relatorio">Trabalho Social</label>
                                        <input id="vlr_trabalho_social" type="text" class="form-control  input-relatorio" name="vlr_trabalho_social" value="{{number_format($dadosPnhr->vlr_trabalho_social, 2, ',' , '.')}}" disabled >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="column col-xs-12 col-md-3">
                                        <label class="control-label label-relatorio">Tx Administração</label>
                                        <input id="vlr_taxa_administracao" type="text" class="form-control  input-relatorio" name="vlr_taxa_administracao" value="{{number_format($dadosPnhr->vlr_taxa_administracao, 2, ',' , '.')}}" disabled >
                                    </div>
                                    <div class="column col-xs-12 col-md-3">
                                        <label class="control-label label-relatorio">Tx Adm Cisterna</label>
                                        <input id="vlr_taxa_adm_cisterna" type="text" class="form-control  input-relatorio" name="vlr_taxa_adm_cisterna" value="{{number_format($dadosPnhr->vlr_taxa_adm_cisterna, 2, ',' , '.')}}" disabled >
                                    </div>
                                    <div class="column col-xs-12 col-md-3">
                                        <label class="control-label label-relatorio">Tx Risco Crédito</label>
                                        <input id="vlr_taxa_risco_credito" type="text" class="form-control  input-relatorio" name="vlr_taxa_risco_credito" value="{{number_format($dadosPnhr->vlr_taxa_risco_credito, 2, ',' , '.')}}" disabled >
                                    </div>
                                    <div class="column col-xs-12 col-md-3">
                                        <label class="control-label label-relatorio">Diferença Juros</label>
                                        <input id="vlr_diferenca_juros" type="text" class="form-control  input-relatorio" name="vlr_diferenca_juros" value="{{number_format($dadosPnhr->vlr_diferenca_juros, 2, ',' , '.')}}" disabled >
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">                                                    
                                    ...
                                    <div class="column col-xs-12 col-md-4">
                                        <label class="control-label label-relatorio"> Liberado</label>
                                        <input id="vlr_liberado" type="text" class="form-control input-relatorio" name="vlr_liberado" value="{{number_format($operacao->vlr_liberado + $dadosPnhr->vlr_liberado_ts_adicional, 2, ',' , '.')}}" disabled >
                                    </div>                             
                                    <div class="column col-xs-12 col-md-4">
                                        <label class="control-label label-relatorio">Saldo a Liberar</label>
