...
use App\oferta\Contratos;
use App\oferta\DevolucaoContratos;
use App\oferta\Instituicao;
use App\oferta\Municipio;
use App\oferta\NotasPagamentoRemessaDevolucao;
use App\oferta\NotasPagamentos;
use App\oferta\PagamentosContrato;
use App\oferta\ParcelasRemessasDevolucao;
use App\oferta\ProtocolosInstituicao;
use App\oferta\RemessaDevolucao;
use App\oferta\PagamentosParcelasRemessaDevolucao;
...
class RemessasDevolucaoController extends Controller
{
        ...
        public function index()
    {
        ...
        return view('oferta.filtro_relatorio_devolucao', compact('remessas'));
    }
    ...
    public function remessaDevolucao(Request $request)
    {
		...
		$whereContratos[] =  ['remessa_devolucao_id', $request->remessa_devolucao_id ];
    ...
    //										 ->sortBy('beneficiario.txt_nome_beneficiario');
    	...
    	return view('oferta.relatorio_remessa_devolucao', compact('remessaDevolucao','parcelasRemessas','instituicao','totalPago'));
    ...
    public function devolucaoContrato(RemessasDevolucao $remessaDevolucao, Contratos $contrato)
    {
    	...
    	//return $notasContrato;
    	return view('oferta.notas_remessa_devolucao_contrato', compact('notasContrato','beneficiario','contrato','remessaDevolucao','totalSubvencao','totalRemuneracao'));
...
//return $notasContrato;
        ...
        return view('oferta.notas_remessa_devolucao_if', compact('notasRemessa','beneficiario','contrato','remessaDevolucao','totalSubvencao','totalRemuneracao','instituicao'));
    ...
    public function filtroDevolucoesIF()
    {
        ...
        return view('oferta.filtro_devolucoes_if', compact('instituicoes'));
...
//return $notasRemessa;
        ...
        return view('oferta.notas_devolucao_if', compact('notasRemessa','beneficiario','contrato','totalSubvencao','totalRemuneracao','instituicao'));
