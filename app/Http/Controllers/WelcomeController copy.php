...
class WelcomeController extends Controller
{
    ...
    public function salvarRegistro(Request $request){
            ...
            $usuario->load('entePublicoProponente');
               ...
               // return $entePublico;
                ...
                if($request->file('txt_caminho_oficio')){
                    $nomeArqOficio = 'arqOficio-'.$request->municipio.'.'.$request->file('txt_caminho_oficio')->extension();
        ...
        if (!$salvoComSucessoUsu || !$salvoComSucessoEnte || !$salvoComSucessoPermissoes){            
            ...
            Mail::to('suporte.sishab@mdr.gov.br')->send(new NovoUsuario($usuarioNovo, $permissoes));
            DB::commit();
