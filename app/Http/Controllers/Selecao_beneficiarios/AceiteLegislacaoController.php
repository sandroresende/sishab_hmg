...
use App\Mod_selecao_demanda\Legislacao;
    ...
    public function index()
    {
       ...
       // return $legislacaoObrigatoria;
        ...
        if(Auth::user()->isUserAtivo()){
            return view('views_selecao_beneficiarios.documentos_especificacoes' ,compact('usuario', 'legislacao', 'legislacaoObrigatoria','dte_aceite_termo'));        
        }
        else
            {
