...
class ProtocolosController extends Controller
{
    ...
    public function filtro_protocolos(){
        ...
        return view('views_sishab.oferta_publica.filtroProtocolos');    
    } 
    ...
    public function protocolos(Request $request){
        ...
        return view('views_sishab.oferta_publica.Protocolos',compact('protocolos','municipio','estado'));    
    }

    public function contratos_protocolo(Instituicao $instituicao, Protocolo $protocolo){
        //return $instituicao;
        ...
        return view('views_sishab.oferta_publica.contratos',compact('protocolo','contratos', 'qtd_restricao','qtd_devolvido','qtd_entregue','qtd_concluida',
                                                'contratosParcelas','qtd_andamento','mediaPercProtocolos','totalSubvencao','totalParcelas','instituicao'));
    }
    ...
    public function protocolo(Request $request){
        ...
        if($protocolo){
            ...
            return view('views_sishab.oferta_publica.contratos',compact('protocolo','contratos','contratosParcelas', 'totalSubvencao','totalParcelas','qtd_restricao','qtd_devolvido','qtd_entregue','qtd_concluida','qtd_andamento'));
        }else{
    ...
    public function filtro_protocolos_if(){
        ...
        return view('views_sishab.oferta_publica.filtroProtocolosIf',compact('instituicoes'));
    ...
    public function protocolos_instituicao(Request $request){
        ...
        return redirect('/oferta_publica/protocolos/instituicao/'.$request->instituicao_id);
    }

    public function dados_protocolos_instituicao(Instituicao $instituicao){    
        //return $instituicao;
       ...
       $protocolos = FaixaExecucao::selectRaw('sg_uf,ds_municipio, protocolo_id, txt_protocolo, num_oferta,COUNT(contrato_id) AS total_uh, 
        ...
        return view('views_sishab.oferta_publica.protocolosInstituicao',compact('protocolos','instituicao'));
    }
