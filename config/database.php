...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'pgsql_bv' => [
            'driver' => 'pgsql',
            'host' => env('DB_HOST_BV', '127.0.0.1'),
            'port' => env('DB_PORT_BV', '5432'),
            'database' => env('DB_DATABASE_BV', 'forge'),
            'username' => env('DB_USERNAME_BV', 'forge'),
            'password' => env('DB_PASSWORD_BV', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'schema' => ['ofertapublica','savio'],
            'sslmode' => 'prefer',
        ],
